...
var LOCK_RENEW_TIME = 50000; 
var CLIENT_CLOSE_TIMEOUT_MS = 5000;
var POLLING_INTERVAL = 5000;
console.log("MIN REDIS VERSION:", MINIMUM_REDIS_VERSION," LOCK RENEW TIME:", LOCK_RENEW_TIME,"CLIENT_CLOSE TIMEOUT:", CLIENT_CLOSE_TIMEOUT_MS,"POLLING INTERVAL:", POLLING_INTERVAL)
...
var Queue = function Queue(name, redisPort, redisHost, redisOptions){
  ...
  console.log('client port:', redisPort, ' host:', redisHost, ' dbnumber:', redisDB)
...
Queue.prototype.processJob = function(job, renew){
  ...
  var lockRenewer = function(){
    console.log('lockRenewer for job:', job.data)
  ...
  return lockRenewer().then(function(locked){
    console.log("after lock renewer.. locked?", locked)
    if(locked){
