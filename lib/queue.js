...
Queue.prototype.run = function(concurrency){
  ...
  return this.processStalledJobs().then(function(){
    ...
    while(concurrency--){
      console.log("PUSHING PROMISES for processJobs")
...
Queue.prototype.processJobs = function(resolve, reject){
  console.log("[Queue.prototype.processJobs]")
  var _this = this;
...
Queue.prototype.processJob = function(job, renew){
  console.log("[Queue.prototype.processJob]")
  var _this = this;
  var lockRenewId;
  ...
  var lockRenewer = function(){
    ...
    console.log("LOCK RENEWER: calling takeLock token:", _this.token)
  ...
  return lockRenewer().then(function(locked){
    console.log("..then locked?:", locked)
    if(locked){
...
Queue.prototype.getJobs = function(queueType, type, start, end){
  console.log("[Queue.prototype.getJobs]")
  var _this = this;
  ...
  console.log("[Queue.prototype.getJobs], jobs:",jobs)
